  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Tomando el control y aplicando el seguimiento en la empresa.
        p.mb-4 Reforzar los conceptos  relacionados con el control y seguimiento administrativo, para contribuir al desarrollo y alcance de lo propuesto en la planeación
