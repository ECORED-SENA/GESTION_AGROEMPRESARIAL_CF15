  ...
  .container.bg-white.p-md-5.p-4.container-bottom.mt-0.cs.mb-5 
    ...
    .row.justify-content-center.mb-5
      .col-lg-10(data-aos="fade")
        figure
          img(src='@/assets/curso/images/tema3/info.svg')
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left") 
      .col-md-5.col-lg-5.mb-5.mb-lg-0
        .tarjeta-avatar
          ...
          .tarjeta.color-custom-5
            .p-4
              h5.text-center.m-top-1 Estadística descriptiva
      ...
      .col-md-5.col-lg-5.mb-5.mb-lg-0
        .tarjeta-avatar
          ...
          .tarjeta.color-custom-5
            .p-4
              h5.text-center.m-top-1 Estadística inferencial
  ...
  .container.bg-white.p-md-5.p-4.container-bottom.mt-0.cs.mb-5 
    ...
    .tarjeta.bg_grad-01.p-4.mb-5(data-aos="zoom-in-up")
      SlyderA(tipo="b")
        ...
        .row.justify-content-center.align-items-star.p-3
          .col-lg-4
            h3.mb-5 Aportar a la aplicación de metodologías de análisis de otros oficios o profesiones
            p.mb-0 El análisis de datos es aplicable a casi cualquier campo en el que se desenvuelva la humanidad; de esta forma la estadística facilita el anticiparse a situaciones propias de otras disciplinas, como el potencial impacto a nivel mundial de un nuevo virus descubierto en la actualidad.
          .col-lg-8
            img(src="@/assets/curso/images/tema3/img_16.png").mb-3
        ...
        ImagenInfografica.color-acento-botones.mb-3
          ...
          .tarjeta.color-custom-7.p-3(x="67%" y="80%" numero="+")
            .row.justify-content-center.align-items-center
              .col-lg-12.mb-4.mb-lg-0
                h5.mb-2 Continua     
                p.mb-0 Los valores que puede tomar este tipo de variables pueden involucrar infinidad de intervalos, que van más allá de los números enteros. Por ejemplo, los porcentajes de participación de los accionistas de una empresa (3,5 %, 22,6%).
    ...
    .tarjeta.tarjeta--gris.p-4.mb-5(data-aos="zoom-in-up")
